...
## Installation
- Install the [tampermonkey](https://tampermonkey.net) extension in the Chromium-based browser or Firefox browser. The [kiwi browser](https://kiwibrowser.com/) is recommended for iPad and Android tablets.
...
- Full-screen bottom "F" and Esc botton "E"; (!~~@) The F bottom does not work correctly now (%~%)
